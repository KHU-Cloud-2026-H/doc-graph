...
| 컨테이너 | 포트 | 용도 | 비고 |
| --- | --- | --- | --- |
| postgres | 5432 | 로컬 개발 DB | named volume (데이터 유지) |
| postgres-test | 5433 | 시스템 테스트 전용 DB | tmpfs (테스트마다 초기화), profile: full |
| ngrok | 4040 | Notion Webhook 로컬 수신 | NGROK_AUTHTOKEN 필요, localhost:8080 터널링 |
| backend | 8080 | Spring Boot 컨테이너 | profile: full (프론트/인프라 개발 시) |
